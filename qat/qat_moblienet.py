...
scripted_qat_model_file ='mobilenetv2_qat_scripted.pth'
...
log(file_name,'Evaluation accuracy on %d images, %2.2f'%(num_eval_batches * eval_batch_size, top1.avg))
...
print("Size of model after perchannel quantization")

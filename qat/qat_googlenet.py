...
scripted_qat_model_file = 'googlenet_qat_scripted.pth'
...
log(file_name,f'baseline Evaluation accuracy on {num_eval_batches * eval_batch_size} images, {top1.avg}')

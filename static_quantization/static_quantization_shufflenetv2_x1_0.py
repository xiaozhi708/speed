...
import torch.nn as nn
import sys
from util import _replace_relu
...
class ShuffleNetV2(nn.Module):
    def __init__(self, stages_repeats=[4, 8, 4], stages_out_channels= [24, 116, 232, 464, 1024], num_classes=102,inverted_residual=InvertedResidual):

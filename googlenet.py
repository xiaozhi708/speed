...
parser.add_argument('--model_type',default='googlenet',help='the choice of model option like:mobilenetv2,shufflenetv2_x1_0，vgg16_bn, resnet50,googlenet,densenet121')

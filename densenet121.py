...
parser.add_argument('--model_type',default='densenet121',help='the choice of model option like:vgg16_bn, resnet50,googlenet,densenet121')
...
if __name__=='__main__':
    ...
    # 保存最好的模型和曲线图
    torch.save(best_model, args.model_save_dir+args.model_type+'.pth') #保存最好的模型
